...
#                 corrected erroneous entries into pot_value_int that cannot be converted to integers (e.g. letters).  
#                 However, I could not get it to catch BOTH negative numbers and other invalid entries within one loop,
#                 so I omitted the "try" and "except" error reporting functions for this program. 


import random

# Keep playing game or exit.
